...
const otherPasswords = {
  ...
  recipebook: "$2a$10$66wlzROaABqZu/O8taawYe5frp2JW3n0HoN0flSDyR4bWZB0RU4Gm" 
};
...
inquirer.prompt(prompts).then(async answers => {
  ...
  // @ts-ignore
  let hasAuth = projectChoice.toLowerCase().includes("other");
  // @ts-ignore
  let isServer = projectChoice.toLowerCase().includes("other");
  // @ts-ignore
